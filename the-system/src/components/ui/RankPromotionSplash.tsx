...
const styles = StyleSheet.create({
  ...
  rankLetter: { fontFamily: 'Lora_600SemiBold', fontSize: 122, fontWeight: 'bold', letterSpacing: 0.5 },
  rankLabel: { fontFamily: 'Lora_600SemiBold', fontSize: 26, fontWeight: 'bold', letterSpacing: 0.5, marginTop: -16 },
  title: {
  ...
  tap: { fontFamily: 'Lora_600SemiBold', fontSize: 12, color: '#666666', letterSpacing: 0.5, marginTop: 48 },
});
