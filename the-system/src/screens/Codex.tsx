...
const styles = StyleSheet.create({
  ...
  iconBox: { width: 44, height: 44, borderWidth: 1, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  ...
  toggleBtn: { borderWidth: 1, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 2 },
  ...
  input: { borderWidth: 1, borderRadius: 2, padding: 8, fontSize: 12, marginBottom: 4 },
  diffRow: { flexDirection: 'row', gap: 8 },
  diffOption: { flex: 1, borderWidth: 1, padding: 6, alignItems: 'center', borderRadius: 2 },
  ...
  submitText: { color: '#000000', fontSize: 11, fontWeight: 'bold', letterSpacing: 1 },
});
